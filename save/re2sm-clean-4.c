...
void S(_*a, _**b, char *c, _**d, void (*e)(_*a, _**b, char *c, _**d)){
 _*f;
 if (a) {
  f = 1[*a];
  e(a, b, c, d);
...
void N(int a, _**b, _**c, void (*d)(int a, _**b, _**c)){
 if (a != 127) {
  d(a, b, c);
  N(++a, b, c, d);
 }
...
void P(char *a, _**b, int *c, char d[127], int e) {
 if (a[*c] && a[*c] != 93) {
  a[(*c)++][d] = !e;
  P(a, b, c, d, e);
 }
